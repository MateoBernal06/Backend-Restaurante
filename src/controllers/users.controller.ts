...
import { createUser, loginUser, getUser } from "../models/users.model";
...
const createUserController = async (req: Request, res: Response) => {
  try {
    ...
    const newUser: CreateUserDTO = {
      ...
      password: await encryptionPassword(password.trim()),
      rol,
...
const loginUserController = async (req: Request, res: Response) => {
  try {
    ...
    const login = await comparePassword(
      user.password,
...
export { createUserController, loginUserController, profileUserController };
